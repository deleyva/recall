...
// Deps carries every service the API needs. A struct rather than a positional
// argument list — the constructor had grown long enough that arg order was a
// hazard, and new subsystems get added here without touching call sites.
type Deps struct {
